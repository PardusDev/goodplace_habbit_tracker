...
import 'package:goodplace_habbit_tracker/widgets/HabitListTile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _mainModel.fetchHabits(context);
    });
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Maybe we can change to FutureBuilder
          Consumer<HomePageViewModel>(
            builder: (context, viewModel, child) {
              if (viewModel.habitsIsLoading) {
              ...
              return ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return HabitListTile(title: viewModel.habits[index].title, imageUrl: 'https://www.theinspiringjournal.com/wp-content/uploads/2024/08/77-Morning-Motivational-Quotes-for-Success.jpg', onPressed: () {  }, isCompleted: false,);
                },
              );
            }
          )
