...
class _ManageMyHabitsPageState extends State<ManageMyHabitsPage> {
  ...
  late ManageMyHabitsViewModel _manageMyHabitModel;

  @override
  void initState() {
    super.initState();
    _homeModel = Provider.of<HomePageViewModel>(context, listen: false);
    _manageMyHabitModel = Provider.of<ManageMyHabitsViewModel>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    _manageMyHabitModel = Provider.of<ManageMyHabitsViewModel>(context, listen: true);
  ...
  Widget _buildGridItem(int index) {
    ...
    return GestureDetector(
      onTap: (){
        _manageMyHabitModel.navigateToManageMyHabits();
      },
      child: Stack(
        children: [
         Container(
